...
export default function SlateTranscriptEditor(props) {
  ...
  const handleSeekBack = () => {
    if (mediaRef && mediaRef.current) {
      mediaRef.current.currentTime =
        mediaRef.current.currentTime - SEEK_BACK_SEC;
    }
  };
  ...
  const handleSave = () => {
    const format = props.autoSaveContentType
      ? props.autoSaveContentType
      : "digitalpaperedit";
  ...
  return (
    <Container
      fluid
      style={{ backgroundColor: "#eee", height: "100vh", paddingTop: "1em" }}
    >
      <style scoped>
        {`
              /* Next words */
            ...
            <>
              <section className="editor-wrapper-container">
                ...
                >
                  <Editable
                    readOnly={
                      typeof props.isEditable === "boolean"
                        ? !props.isEditable
                        : false
                    }
          ...
          <Row>
            ...
            >
              <OverlayTrigger
                ...
                placement={"bottom"}
                overlay={
                  <Tooltip id="tooltip-disabled">Export options</Tooltip>
                }
              >
                <span className="d-inline-block">
                  <DropdownButton
            ...
            >
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip id="tooltip-disabled">
                    To insert a paragraph break, and split a pargraph in two,
                    put the cursor at a point where you'd want to add a
                    paragraph break in the text and either click this button or
                    hit enter key
                  </Tooltip>
                }
              >
            ...
            >
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip id="tooltip-disabled">
                    Put the cursor at a point where you'd want to add
                    [INAUDIBLE] text, and click this button
                  </Tooltip>
                }
              >
            ...
            >
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip id="tooltip-disabled">
                    Turn {isPauseWhiletyping ? "off" : "on"} pause while typing
                    functionality. As you start typing the media while pause
                    playback until you stop. Not reccomended on longer
                    transcript as it might present performance issues.
                  </Tooltip>
                }
              >
                <Button
            ...
            >
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip id="tooltip-disabled">
                    Restore timecodes. At the moment for transcript over 1hour
                    it could temporarily freeze the UI for a few seconds
                  </Tooltip>
                }
              >
            ...
            >
              <OverlayTrigger
                ...
                overlay={
                  <Tooltip id="tooltip-disabled">
                    Double click on a paragraph to jump to the corresponding
                    point at the beginning of that paragraph in the media
                  </Tooltip>
                }
              >
                {/* <span className="d-inline-block"> */}
